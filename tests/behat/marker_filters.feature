...
Feature: Marker dashboard filters and limits
  ...
  Scenario: Marker view shows a maximum of 5 items ordered by due date
    ...
    And I should see "Test assignment" before "Assign 2"
    And I should see "Assign 2" before "Assign 3"
    And I should see "Assign 3" before "Assign 4"
    And I should see "Assign 4" before "Assign 5"
